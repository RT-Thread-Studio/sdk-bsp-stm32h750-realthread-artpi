...
#define CN470S_INIT_DEFAULTS( )                     CN470S_CASE { RegionCN470SInitDefaults( params ); break; }
#define CN470S_GET_NVM_CTX( )                       CN470S_CASE { return RegionCN470SGetNvmCtx( params ); }
...
#define CN470S_ALTERNATE_DR( )                      CN470S_CASE { return RegionCN470SAlternateDr( currentDr, type ); }
...
#define CN470S_RX_BEACON_SETUP( )                   CN470S_CASE { RegionCN470SRxBeaconSetup( rxBeaconSetup, outDr ); break; }
#else
#define CN470S_IS_ACTIVE( )
#define CN470S_GET_PHY_PARAM( )
#define CN470S_SET_BAND_TX_DONE( )
#define CN470S_INIT_DEFAULTS( )
#define CN470S_GET_NVM_CTX( )
